...
class SearchByInvoiceIdScreen extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:commonText(title: "Search By Invoice Id :", fontWidget: FontWeight.bold,fontSize: 70.sp,color: Colors.white),
      ),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      controller.searchBoolButton == false ? InkWell(
                            onTap: (){
                              controller.searchProductById(_formValidationController.searchProductController.text.trim());
                            },
                    ...
                    controller.searchBoolById == true ?  Column(
                      children: [
                        ...
                        ListView.builder(
                            ...
                            itemCount: controller.snapshotOFById.docs.length,
                                      ...
                                      children: [
                                        ...
                                        TableCell(
                                            child: Padding(
                                              ...
                                              child: Center(
                                                  child: commonText(
                                                      title: controller.snapshotOFById.docs[index]['id'],
                                                      color: Colors.black,
                                                      fontSize: 40.sp,
                                        ...
                                        TableCell(
                                            child: Padding(
                                              ...
                                              child: Center(
                                                  child: commonText(
                                                      title: controller.snapshotOFById.docs[index]['subTotal'],
                                                      color: Colors.black,
                                                      fontSize: 40.sp,
                                                      fontWidget: FontWeight.w400)),
                                            )),
                                        TableCell(
                                            child: Padding(
                                              ...
                                              child: Center(
                                                  child: commonText(
                                                      title: controller.snapshotOFById.docs[index]['disc'],
                                                      color: Colors.black,
                                                      fontSize: 40.sp,
                                                      fontWidget: FontWeight.w400)),
                                            )),
                                        TableCell(
                                            child: Padding(
                                              ...
                                              child: Center(
                                                  child: commonText(
                                                      title: controller.snapshotOFById.docs[index]['grandTotal'],
                                                      color: Colors.black,
                                                      fontSize: 40.sp,
                                                      fontWidget: FontWeight.w400)),
                                            )),
                                        TableCell(
                                            child: Padding(
                                              ...
                                              child: Center(
                                                  child: commonText(
                                                      title: controller.snapshotOFById.docs[index]['day'],
                                                      color: Colors.black,
                                                      fontSize: 40.sp,
                                                      fontWidget: FontWeight.w400)),
                                            )),
                                              ...
                                              children: [
                                                InkWell(
                                                    onTap: () {
                                                      ...
                                                      controller.snapshotOFById.docs[index]['subTotal'];

                                                      controller.discController.text =
                                                      controller.snapshotOFById.docs[index]['disc'];
                                                                    ...
                                                                    return Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          width: 500.w,
                                                                          child: Form(
                                                                              key: controller.updateByIdForSearchFormKey,
                                                                              ...
                                                                              child: InkWell(
                                                                                onTap:
                                                                                  ...
                                                                                  controller.updateProductById(
                                                                                      controller.snapshotOFById.docs[index]['id']
                                                                                  );
                                                                                },
                                                                                child: Center(
                                                                                    child:
